...
void CubePass() {
  ...
  //    * Al renderizar m�ltiples objetos en la misma escena, se comparte la misma matriz view y projection) para todos,
  //    pero cada objeto tendr� su propia matriz model en funci�n de su posici�n y orientaci�n.
  //
