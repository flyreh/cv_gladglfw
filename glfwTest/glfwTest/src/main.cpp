...
glm::vec3 cameraFront = glm::vec3(0.0f, 0.0f, -1.0f); // Dirección de la cámara (hacia dónde "mira")

glm::vec3 cameraUp = glm::vec3(0.0f, 1.0f, 0.0f); // Vector de "arriba" de la cámara para evitar que se voltee
...
int main() {
    ...
    */
    ...
    while (!glfwWindowShouldClose(_window)) {
        ...
        glm::mat4 projection = glm::perspective(glm::radians(45.0f), (float)_windowedWidth / (float)_windowedHeight, 0.1f, 100.0f); // Matriz de proyección (define frustum sencillo)
        ...
        model = glm::mat4(1.0f); // Reinicia la matriz modelo a la identidad (Es como hacer un PushMatrix-PopMatrix)
